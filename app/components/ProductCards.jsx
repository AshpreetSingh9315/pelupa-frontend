...
const ProductCards = (props) => {
  return (
    <section className="max-w-7xl mx-auto py-10  px-3 sm:px-3 lg:px-0 md:px-0 ">
      {/* Section Heading */}
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-black tracking-tight ">{props.title}</h2>
        <h2 className="text-sm font-bold text-blue-700 flex justify-center items-center cursor-pointer">
          View All <ArrowBigRightDash size={16} />
        </h2>
      </div>
            ...
            >
              <div className="w-full h-52 bg-gray-100 relative">
                ...
                <div className="absolute bottom-0 bg-yellow-400 w-full rounded-b-lg flex px-3 py-2 justify-between">
                  ...
                  <small className="text-xs font-bold px-2 bg-white">
                    Star
                  </small>
                </div>
              </div>
