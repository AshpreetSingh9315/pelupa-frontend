...
import { Star, Heart, ArrowBigRightDash } from "lucide-react";
...
export default function Categories() {
  ...
  const [products] = useState([
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1609592806427-ef7e6650aa11?w=400&h=300&fit=crop",
      salePrice: 1399,
      regularPrice: 3499,
      rating: 4.6,
      reviews: 89,
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {sortedProducts.map((product) => (
            <Link key={product.id} href={`/categories/${product.id}`} passHref>
              <div>
